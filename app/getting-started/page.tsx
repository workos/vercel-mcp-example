...
const steps = [
  ...
  },
  {
    ...
    description: "Replace the example tools with your own business logic and learn key patterns",
    duration: "10 min",
    icon: (
      <svg
      ...
      <div className="max-w-4xl mx-auto pt-24 px-4 pb-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-neutral-400 max-w-3xl mx-auto">
            Learn how to build your own enterprise-ready MCP server with WorkOS authentication. 
            Each step guides you through implementing your own business logic while leveraging 
            the powerful authHandler pattern.
          </p>
        </div>
