...
export default function TestingSection({ user }: TestingSectionProps) {
  ...
  const [debugOutput, setDebugOutput] = useState(
    user
      ? 'Click "Test Now" to get your user profile via MCP'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-neutral-400 max-w-3xl mx-auto">
            This demo implements the exact authHandler pattern described above.
            Test both endpoints to see how authentication works in practice—one
            is public, one requires WorkOS login.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-neutral-800 dark:to-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-3xl p-8">
            ...
            <p className="text-gray-700 dark:text-neutral-300 mb-6">
              This calls the MCP{' '}
              <code className="px-2 py-1 bg-gray-200 dark:bg-neutral-700 rounded text-sm">
                ping
              </code>{' '}
              tool, which demonstrates a <strong>public endpoint</strong> in
              your MCP server. Notice it works whether you&apos;re signed in or
              not—ideal for health checks and monitoring.
            </p>

            <div className="bg-white dark:bg-neutral-800 border border-gray-300 dark:border-neutral-600 rounded-lg p-4 mb-6">
              <div className="mb-2">
                <span className="text-sm font-mono text-gray-600 dark:text-neutral-400">
                  MCP Response:
                </span>
              </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border border-blue-200 dark:border-blue-800 rounded-3xl p-8">
            ...
            <p className="text-blue-800 dark:text-blue-200 mb-6">
              This calls the MCP{' '}
              <code className="px-2 py-1 bg-blue-200/50 dark:bg-blue-800/50 rounded text-sm">
                getUserProfile
              </code>{' '}
              tool, demonstrating the <strong>authHandler pattern</strong>. It
              validates your JWT, fetches your profile from WorkOS, and returns
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-3xl p-8">
            ...
            <p className="text-purple-800 dark:text-purple-200 mb-6">
              Use the official MCP Inspector to{' '}
              <strong>list available tools</strong> and verify your server is
              responding. This tests basic connectivity without requiring
              authentication.
            </p>
            ...
            <div className="bg-white dark:bg-neutral-800 border border-purple-300 dark:border-purple-600 rounded-lg p-4 mb-6">
              ...
              <pre className="text-sm text-purple-800 dark:text-purple-200 font-mono whitespace-pre-wrap break-words">
                npx @modelcontextprotocol/inspector --cli {mcpUrl} --method
                tools/list --transport http
              </pre>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-3xl p-8">
            ...
            <p className="text-purple-800 dark:text-purple-200 mb-6">
              Test <strong>authenticated MCP tools</strong> using the Inspector
              with your auth token.
              {user
                ? 'You can get your current session token from the browser.'
            ...
            <div className="bg-white dark:bg-neutral-800 border border-purple-300 dark:border-purple-600 rounded-lg p-4 mb-6">
              ...
              <pre className="text-sm text-purple-800 dark:text-purple-200 font-mono whitespace-pre-wrap break-words">
                npx @modelcontextprotocol/inspector --cli {mcpUrl} --method
                tools/call --tool-name getUserProfile --transport http --header
...
4. Replace YOUR_TOKEN in the command above`;
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-600 dark:text-neutral-400 mb-8 max-w-3xl mx-auto">
            This demonstrates the core value proposition: add authentication to
            any MCP server with minimal code changes using the authHandler
            pattern.
          </p>
